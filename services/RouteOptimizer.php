 ...
 * que estaban dispersas en RouteController, HojaRutaController y RouteCostCalculator.
 */
...
class RouteOptimizer
{
    ...
    public function __construct(?DistanceCache $distanceCache = null)
    {
        $this->distanceCache = $distanceCache ?? new DistanceCache();
    }

    // ── 2-opt con matriz de distancias (km) ──────────────────
    // Versión original de RouteController: trabaja con índices offset +1 (depot = 0)
