...
CREATE TABLE IF NOT EXISTS hojas_ruta (
    ...
    vehicle_id INT UNSIGNED NULL                COMMENT 'Vehiculo asignado a la hoja',
    ...
    estado ENUM('borrador','cerrada','en_reparto','completada') DEFAULT 'borrador',
    total_cc DECIMAL(8,2) DEFAULT 0,
    total_carros DECIMAL(8,2) DEFAULT 0,
    total_cajas DECIMAL(8,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS hoja_ruta_lineas (
    ...
    zona VARCHAR(100),
    carros DECIMAL(8,2) DEFAULT 0,
    cajas DECIMAL(8,2) DEFAULT 0,
